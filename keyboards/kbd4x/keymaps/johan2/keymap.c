...
// STANDARD
  [0] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_RALT, MO(1),   LT(3, KC_SPACE),  MO(2),   KC_LBRC, KC_LCBR, KC_RCBR,  KC_RBRC
  ),

// LOWER (LEFT)
  [1] = LAYOUT_planck_mit(
    KC_GRAVE, KC_1,    KC_2,    KC_3, KC_4, KC_5, KC_6,    KC_7,    KC_8,    KC_9,      KC_0,     KC_BSPC,
    KC_TILDE, RGB_TOG, KC_PSCR, ___,  ___,  ___,  KC_COMM, KC_4,    KC_5,    KC_6,      KC_BSLS,  KC_ENTER,
    ___,      KC_BSLS, KC_DEL,  ___,  ___,  ___,  KC_DOT,  KC_1,    KC_2,    KC_3,      KC_PIPE,  KC_INS,
    ___,      ___,     ___,     ___,  ___,  KC_SPACE,      KC_0,    KC_HOME, KC_PGDN,   KC_PGUP,  KC_END
  ),
...
// FUNCTION (SPACE)
  [3] = LAYOUT_planck_mit(
    ...
    ___,     ___,     ___,     ___,      ___,    ___,              ___,     KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
  ),
};
